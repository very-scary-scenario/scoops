...
franchise_a = ['Dark', 'Steel', 'Modern', 'Virtua', 'Burning', 'Half', 'Dead', 'Demon', 'Iron',
    ...
    'Dungeon', 'Team', 'Hard', u'Mirror’s', 'Love', 'Saints', 'Dragon', 'Black', 'L.A.', 'Mass',
    ...
    u'Assassin’s', 'Warp', 'War', 'Medal of', 'Jet Set', 'Oregon', 'Mercenary', 'Tecmo', 'Mega',
    ...
    'Ocarina of', 'Theme', 'Hyperdimension', u'Kirby’s', 'Epic', u'Dante’s', 'Mecha', u'Yoshi’s',
    'Paper'
    ]
...
name = ['Ultimate %s', 'The %s', '%s', '%s: Reckoning', '%s 2', '%s 3', '%s 4', '%s 5', '%s 9',
    ...
    '%s: Ground Zero', u'%s: An Item Shop’s Tale', '%s 2013', '%s 2048', '%s: Shadow of Chernobyl',
    '%s: Call of Pripyat', u'Sid Meier’s %s', '%s: Beyond the Sword', '%s: Warlords', 'Shogun: %s',
    '%s: The Ultimate in Mayonaka Arena', 'The Wonderful %s', '%s 2004', '%s 3D', '%s IV', '%s V',
    '%s: Terror from the Deep', u'Peter Jackson’s %s: The Official Game of the Movie', '%s VII',
    ...
    'No One Can Stop %s', 'Feel the Magic: %s', 'Knights of %s', 'Codename: %s', u'%s ’13',
...
company = ['Lionhead', 'Microsoft', 'Sony', 'Polytron', 'Sega', 'Nintendo', 'Activision', 'EA',
    ...
    u'Traveller’s Tales', 'Naugty Dog', 'WayForward', 'CINEMAX', 'Nnooo', 'Bullfrog',
